...
public class ProductBusiness {
	...
	//
	// long productId = ScannerUtils.findIdProduct("Please insert the id of the
	// product to be changed: ", false);
	// if (productId == (long) -2) {
	// ConsultProducts();
	//
	// } else {
	// Product productToBeChanged =
	// productRepository1.ConsultEntityById(productId);
	//
	// int iva = ScannerUtils.getValidIntFromScanner(
	// "Please insert the iva: Actual iva: (" + productToBeChanged.getIva() +
	// ")", ivas, true);
	//
	...
	// "Please insert the pvp: Actual pvp: (" + productToBeChanged.getPvp() +
	// ")", true);
	//
	...
	// long shelfId = ScannerUtils.findIdShelf("Please insert the id of the
	// shelf to be changed: ", false);
	// long productId;
	...
	// .findIdProduct("Please insert new id of the product to be stored: Actual
	// id: ("
	// + actualIdProduct + ")", true);
	// } else {
	// productId = ScannerUtils.findIdProduct(
	// "Please insert new id of the product to be stored: Actual id: (no product
	// stored)",
	// true);
	// }
	...
	// "Please insert the new shelf capacity: Actual capacity: (" +
	// actualCapacity + ")", true);
	//
	// double price = ScannerUtils.getDoubleFromScanner(
	// "Please insert the new rent price (diary): Actual rent price: (" +
	// actualPrice + ")",
	// true);
	//
	// if (productId != (long) -1) {
